...
import com.greedy.music.controller.MusicController;
import com.greedy.music.model.comparator.AscTitle;
import com.greedy.music.model.comparator.DescArtist;
import com.greedy.music.model.comparator.DescTitle;
...
public class MusicMenu {
	...
	public void addList() {
		...
		musicController.addList(new MusicDTO(artist, title));
	}

	public void selectList() {
		System.out.println("===== 곡 전체 조회 =====");
		List<MusicDTO> musicList = musicController.selectList();
	...
	public void searchArtist() {
		...
		List<MusicDTO> searchList = musicController.searchArtist(sc.nextLine());
	...
	public void searchTitle() {
		...
		List<MusicDTO> searchList = musicController.searchTitle(sc.nextLine());
	...
	public void updateMusic() {
		...
		MusicDTO updateMusic = new MusicDTO(updateArtist, updateTitle);
		int result = musicController.updateMusic(title, updateMusic);
	...
	public void removeMusic() {
		...
		System.out.print("삭제할 곡의 제목 : ");
		int result = musicController.removeMusic(sc.nextLine());
